...
public class CustomGeneticAlgorithm {
    ...
    private Chromosome generateDescendant(Chromosome parent1, Chromosome parent2, int relative_sequence_size, int head_size, int tail_size) {
        ...
        sub_sequence.addAll(parent2.getGenotype().subList(0, head_size));
        sub_sequence.addAll(parent2.getGenotype().subList(head_size, head_size + relative_sequence_size));
        parent2.setGenotype(parent2.getGenotype().subList(0, head_size + relative_sequence_size + tail_size));



        sub_sequence.removeAll(genotype);

        genotype.addAll(sub_sequence.subList(0, head_size));
        genotype.addAll(0, sub_sequence.subList(head_size, head_size + tail_size));
